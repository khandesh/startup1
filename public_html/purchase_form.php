...
<form name="purchaseform" method="post" action="purchase_form_action.php" enctype="multipart/form-data">
...
<tr>
 ...
 <td valign="top">
  <input  type="text" name="negotiation" maxlength="50" size="30" required="required" placeholder="Negotiation %(Price above which you can't buy) ">
 </td>
</tr>
...
<tr>
 <td valign="top">
  <label for="comments">Query / Comment (optional)</label>
 </td>
 <td valign="top">
