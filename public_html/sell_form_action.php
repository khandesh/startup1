...
if(isset($_POST['email'])) {
	...
	$email_subject = "ACHEVEND  SELL PLEASE.....";
...
$flgSend = @mail($email_to,"A new file for you!",null,$headers);
*/
	...
	$email_message .= "Negotiation: ".clean_string($negotiation)."\n";
	
        $email_message .= "Email: ".clean_string($email_from)."\n";
	$email_message .= "Telephone: ".clean_string($telephone)."\n";
	$email_message .= "Condition of product: ".clean_string($comments)."\n";
      $email_message .= "Pic id: ".clean_string($_FILES["file"]["name"])."\n";
